...
def generate_batch_prompts(
    batch_size: int, model_name: str, system_prompt: str = SYSTEM_PROMPT
...
if __name__ == "__main__":
    ...
    random.seed(
        SEED + completed
    )  # shift seed to avoid duplicate early samples on resume
    append_log(
        log_path,
    ...
    while completed < args.num_runs:
        ...
        message_list, metadata_list = generate_batch_prompts(
            batch_size, args.model_name
        )
